...
ERROR_PATTERNS = [
    # (weight, code, reason, source, step, description, persona_weights)
    (
        40,
        "BAD_REQUEST_ERROR",
        "insufficient_funds",
...
def generate_synthetic_failures(
    ...
    for i in range(count):
        ...
        # Correlate persona with error type for realistic data
        ...
        # Round to nearest 50 paise / 5000 paise
        amount = (amount // 5000) * 5000 if amount > 5000 else amount

        # Randomize timestamp over past 15 days
...
if __name__ == "__main__":
    count = export_sample_failures_json()
    print(f"Successfully generated {count} synthetic failures.")
